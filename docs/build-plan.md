...
The order and dependency links are proposed coordination aids and can change as we learn. **CORE-01 grammar and CORE-18 compiler/validation are Ready**; the remaining **16 tasks are Captured**. All hypotheses are **Untested**. No compiler, working generation, or executed acceptance tests exist yet.
